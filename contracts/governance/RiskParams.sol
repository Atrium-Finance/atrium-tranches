...
//  Premium curve parameters for RP1 risk pricing
...
/**
 * @title RiskParams
 * @notice Stores risk premium curve parameters used by Accounting to compute Senior APR.
 * @dev RP1 = x + y * ratio_sr^k where ratio_sr = Sr / (Sr + Jr).
 *      Timelock is external (PrimeGovernor wraps calls).
 *      See MATH_REFERENCE §E2 for curve formula.
 */
