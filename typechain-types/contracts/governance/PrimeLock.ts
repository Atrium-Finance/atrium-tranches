...
export interface PrimeLockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface PrimeLock extends BaseContract {
  connect(runner?: ContractRunner | null): PrimeLock;
  waitForDeployment(): Promise<this>;

  interface: PrimeLockInterface;
